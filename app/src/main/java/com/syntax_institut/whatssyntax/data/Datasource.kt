...
class Datasource {
    ...
    private val contactList = listOf(
        Contact("Anna Smith", "123-456-7890", R.drawable.doggo, Status("Habe Steinpilze abzugeben.")),
        Contact("Gandalf the Grey", "321-654-0987", R.drawable.gandalf, Status ("You should not Pass")),
        Contact("Grinch", "111-222-3333", R.drawable.grinch, Status("No Christmas this Year!")),
        Contact("Tom Brown", "555-666-7777", R.drawable.grumpy, null),
        Contact("Eric Cartman", "888-999-0000", R.drawable.idontknow, Status("Mom i wont my Iphone15!!!!")),
        Contact("Kenny", "246-135-7920", R.drawable.kenny, Status("I am a Japanese Princess, thx Sony")),
        Contact("Santa Claus", "654-987-3210", R.drawable.santa, null),
        Contact("Heisenberg", "987-654-3210", R.drawable.heisenberg, Status("Lets cook")),
        Contact("Wade Wilson", "444-555-6666", R.drawable.deadpool, Status("I miss you Logan, pls go on the Phone my little Unicorn <3")),
        Contact("Logan", "333-444-5555", R.drawable.wolverine, Status("Stop Calling me WADE!!!!")),
